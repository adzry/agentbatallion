...
export class AnalyzerAgent extends BaseAgent {
  constructor() {
    super(
      'analyzer',
      'Analyzes user requirements and extracts specifications'
    );
  }
...
- SEO and accessibility considerations`;
  ...
  protected async execute(input: Record<string, any>): Promise<AnalysisResult> {
  ...
  private extractComponents(prompt: string): ComponentSpec[] {
  ...
  private extractDataModels(prompt: string): DataModel[] {
  ...
  private extractRoutes(prompt: string): RouteSpec[] {
  ...
  private extractFeatures(prompt: string): FeatureSpec[] {
