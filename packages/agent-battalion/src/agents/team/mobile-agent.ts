...
- Deep linking`,
  ...
  protected async executeTask(task: AgentTask): Promise<any> {
    switch (task.title) {
      case 'generate_mobile':
        ...
        return await this.generateMobileApp(
          reqs as Requirement[],
  ...
  private generateConfigFiles(requirements: Requirement[], designSystem: DesignSystem): ProjectFile[] {
    const files: ProjectFile[] = [];
...
`,
  ...
  private generateNavigation(requirements: Requirement[]): ProjectFile[] {
    const files: ProjectFile[] = [];
...
`,
  ...
  private generateTheme(designSystem: DesignSystem): ProjectFile[] {
    const files: ProjectFile[] = [];
...
`,
  ...
  private generateComponents(designSystem: DesignSystem): ProjectFile[] {
    const files: ProjectFile[] = [];
...
`,
  ...
  private generateScreens(requirements: Requirement[]): ProjectFile[] {
    const files: ProjectFile[] = [];
